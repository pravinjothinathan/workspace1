...
public class ColorManager {
	...
	/**
	 * Add better default color settings
	 * 
	 * Li Ha from nexB
	 * @param store
	 */
	public static void initDefaultColors(IPreferenceStore store) {
		...
		PreferenceConverter.setDefault(store, ColorsPreferencePage.COMMENT1_COLOR, new RGB(64,128,128)); 
		PreferenceConverter.setDefault(store, ColorsPreferencePage.COMMENT2_COLOR, new RGB(64,128,128));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.LITERAL1_COLOR, new RGB(0,0,160));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.LITERAL2_COLOR, new RGB(0,0,255));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.LABEL_COLOR, new RGB(0,128,64));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.KEYWORD1_COLOR, new RGB(128,0,64));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.KEYWORD2_COLOR, new RGB(128,0,64));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.KEYWORD3_COLOR, new RGB(128,0,64));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.KEYWORD4_COLOR, new RGB(64,0,64));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.FUNCTION_COLOR, new RGB(0,64,128));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.MARKUP_COLOR, new RGB(128,0,64));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.OPERATOR_COLOR, new RGB(0,0,64));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.DIGIT_COLOR, new RGB(0,0,0));
		PreferenceConverter.setDefault(store, ColorsPreferencePage.INVALID_COLOR, new RGB(0,0,0));
		...
		store.setDefault(ColorsPreferencePage.KEYWORD2_COLOR + bold,  true);
		store.setDefault(ColorsPreferencePage.KEYWORD3_COLOR + bold,  true);
